class Display {
  ...
  static updateSubHeaderResult(currentRoundResult) {
    ...
    Display.displayElements['subHeaderResult'].classList.remove('tieColor', 'winColor', 'loseColor'); // for text color bug fix
  ...
  static updateMatchResultInfo(matchResultInfo) {
    let matchResultInfoHTML = 
    `<span class="tieColor">${matchResultInfo[0]} ${matchResultInfo[0] > 1 || matchResultInfo[0] < 1 ? `Ties` : `Tie`} - </span>
    <span class="winColor">${matchResultInfo[1]} ${matchResultInfo[1] > 1 || matchResultInfo[1] < 1 ? `Wins` : `Win`} - </span>
    <span class="loseColor">${matchResultInfo[2]} ${matchResultInfo[2] > 1 || matchResultInfo[2] < 1 ? `Loses` : `Lose`}</span>`
